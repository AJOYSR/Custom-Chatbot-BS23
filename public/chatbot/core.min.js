(function () {
  const n = {
    ...
    createButton: function (e) {
      ...
      b.innerHTML = '💬';
      b.style.cssText = `position:fixed;bottom:20px;${e.position}:20px;width:50px;height:50px;border-radius:50%;background-color:${e.buttonColor};color:white;display:flex;align-items:center;justify-content:center;cursor:pointer;box-shadow:0 2px 6px rgba(0,0,0,0.2);font-size:24px;z-index:999999;`;
      b.onclick = () => {
